...
<div class="section">
    ...
    <form id="credentials-form" method="post" class="form-horizontal" action="javascript:void(0);">
        <div class="form-group row">
            <label class="col-12 col-md-12 col-lg-3 col-xl-2 col-form-label text-left text-lg-right font-weight-bold" for="trackmage_client_id"><?php _e( 'Client ID', 'trackmage' ); ?></label>
            <div class="col-12 col-md-12 col-lg-9 col-xl-10 pl-lg-0">
        ...
        <div class="form-group row">
            <label class="col-12 col-md-12 col-lg-3 col-xl-2 col-form-label text-left text-lg-right font-weight-bold" for="trackmage_client_secret"><?php _e( 'Client Secret', 'trackmage' ); ?></label>
            <div class="col-12 col-md-12 col-lg-9 col-xl-10 pl-lg-0">
